...
![Hello World App](/mad9137/assets/img/hello-world.png)

**To run the application:** [Download the HelloWorld project here](/mad9137/assets/downloads/hello-world.zip), unzip it and double-click on the `.xcodeproj` file to open it in Xcode.  From the toolbar, press the run/play button.
