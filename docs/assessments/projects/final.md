...
* create a segue from the prototype cell in the tableViewController to the InfoViewController and give the segue an appropriate identifier **(2pt)**
...
* when this viewController loads, it will wait 3 seconds and then call the `performSegue(withIdentifier, sender)` function to segue to the tableView **(3pt)**
...
* within your URLRequest, you must add value to the URL’s header for the key “my-authentication”, and pass in the first 8 characters of your school’s email address (e.g. lenc0001) as the value **(3pt)**
