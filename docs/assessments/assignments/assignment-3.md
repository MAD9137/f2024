...
* check the 'sender' value you pass to check which button was pressed, and pass the correct Page object to the next view within the `prepare(for Segue, sender)` function function in the 1stand 2nd view **(4pt)**
